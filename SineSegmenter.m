%function SSF=SineSegmenter(d,fs,NW,K,dT,dS,pval)
%
%d=decimate(d,4); fs=fs/4; % if fs>10e3
%ssf=SineSegmenter(d,fs,11,21,0.02,0.01,0.01) % mosquito
%ssf=SineSegmenter(d,fs,12,20,0.1,0.01,0.05) % fruit fly
...
function SSF=SineSegmenter(d,fs,NW,K,dT,dS,pval,fwindow)
