...
%  
=======
function [ssf,winnowed_sine, pps, pulseInfo2, pulseInfo, cmhSong] = Process_Song(xsong,xempty)
...
if numel(pps.start) > 0
    fprintf('Running wavelet transformation on putative pulse segments.\n')
    [pulseInfo, pulseInfo2, cmhSong] = PulseSegmentationv3(xsong,xempty,pps,param.a,param.b,param.c,param.d,param.e,param.f,param.g,param.h,param.i,param.Fs);
