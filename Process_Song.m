...
[ssf] = sinesongfinderV2(song,param.Fs,param.NW,param.K,param.dT,param.dS,param.pval,param.fwindow);
...
[pcndInfo, pulseInfo, pulseInfo2, cmhSong] = ...
    PulseSegmentationv4(xsong,noise.d,[],param.a,param.b,param.c,param.d,param.e,param.f,param.g,param.h,param.i,param.Fs);
...
if param.find_sine == 1
  ...
  if ismember('x',fieldnames(pulseInfo))
    ...
    pm_ssf = sinesongfinderV2(pm_xsong,param.Fs,param.NW,param.K,param.dT,param.dS,param.pval,param.fwindow);
    ...
    elseif pulseInfo2.w0 == 0;
      ...
      if ismember('x',fieldnames(pulseInfo2))
        winnowed_sine = ...
            winnow_sine2(pm_sine,pulseInfo2,pm_ssf,param.max_pulse_pause,param.sine_low_freq,param.sine_high_freq);
      else
        winnowed_sine = ...
            winnow_sine2(pm_sine,pulseInfo,pm_ssf,param.max_pulse_pause,param.sine_low_freq,param.sine_high_freq);
      end
    end
  else
    pulseInfo2 = {};
    ...
    ssf = sinesongfinderV2(xsong,param.Fs,param.NW,param.K,param.dT,param.dS,param.pval,param.fwindow,1);
